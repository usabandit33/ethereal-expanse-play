# Ethereal Expanse v40 Changelog

**Base:** ethereal-expanse-v36.html (canonical full build >50KB; v37–v39.html are 11-byte stubs)  
**Date:** 2026-09-13  
**Type:** Player-trust fix — builders no longer spend wood without N

## Fresh-tester notes on v36

- **Confused me?** Three NPCs walked up to a cow and a pen appeared. Four wood vanished while I was saving for the sword. Tutorial never mentioned a consent key.
...
**Builders silently deducted 4 wood** and competed with camps (5W), cubes (2W), and the sword (20W). v36 flagged it. Later changelogs described the fix but no real build landed.
